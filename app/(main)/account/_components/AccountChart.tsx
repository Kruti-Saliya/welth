...
// Define props type for AccountChart
...
export function AccountChart({ transactions }: AccountChartProps) {
  ...
  const filteredData: TChartData[] = useMemo(() => {
    ...
    const grouped = filtered.reduce<Record<string, TChartData>>((acc, transaction) => {
